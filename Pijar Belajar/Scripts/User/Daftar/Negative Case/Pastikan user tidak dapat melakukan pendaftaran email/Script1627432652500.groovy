...
WebUI.click(findTestObject('Login/Login Email/button_Mulai Belajar'))

WebUI.click(findTestObject('Daftar/Daftar Email/a_Daftar'))

WebUI.setText(findTestObject('Daftar/Daftar Email/input_Email_email'), 'DanianLestari@yopmail.com')
